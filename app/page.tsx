...
export default function Page() {
  return (
    <SiteChrome>
      {/* HERO (single static background, premium styling) */}
      <section
        className="relative isolate flex min-h-[86vh] items-center justify-center overflow-hidden"
        style={{
          backgroundImage:
            "linear-gradient(rgba(3,7,18,0.82), rgba(3,7,18,0.9)), url('https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=2000&auto=format&fit=crop')",
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 0% 0%, rgba(45,212,191,0.18) 0, transparent 55%), radial-gradient(circle at 100% 100%, rgba(56,189,248,0.18) 0, transparent 55%)",
          }}
        />

        {/* Soft glow accents */}
        <div className="pointer-events-none absolute -top-20 -left-32 h-[46vh] w-[46vh] rounded-full bg-emerald-500/18 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-40 -right-40 h-[50vh] w-[50vh] rounded-full bg-sky-500/18 blur-3xl" />
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <input
                ...
                className="h-11 w-full max-w-[520px] sm:w-80 rounded-full border border-white/10 bg-white/5 px-5 text-[14px] placeholder:text-zinc-500 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/70 transition"
              />
            ...
            {/* Trust row */}
            <div className="mt-7 hidden flex-wrap items-center justify-center gap-x-8 gap-y-2 text-[13px] text-zinc-400 sm:flex">
