      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-screen-2xl px-6 sm:px-8">
          <div className="mx-auto max-w-3xl text-center">
            {/* No top label per your request */}

            <h1
              className={`${heroFont.className} text-[clamp(42px,7vw,88px)] font-bold leading-[1.03] tracking-tight`}
            >
            ...
            <p className="mt-6 text-[15px] leading-relaxed text-zinc-200 sm:text-[16px]">
            ...
            {/* CENTRAL START CARD – larger, louder, clearer */}
            <div className="mt-10 mx-auto max-w-2xl rounded-[32px] border border-emerald-100/80 bg-white/98 p-6 shadow-[0_22px_80px_rgba(0,0,0,0.40)] sm:p-7">
              <p className="mb-4 text-center text-[14px] font-medium text-zinc-700">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
                <input
                  ...
                  className="h-14 flex-1 rounded-full border border-zinc-200 bg-white px-5 text-[15px] text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/80"
                />
                <button
                  type="button"
                  className="inline-flex h-14 items-center justify-center rounded-full bg-emerald-500 px-7 text-[15px] font-semibold text-black shadow-sm hover:bg-emerald-400 transition sm:px-9"
                >
            ...
            <p className="mt-8 text-[13px] uppercase tracking-[0.18em] text-zinc-300">
              Built for local businesses across Alabama
            </p>
            <div className="mt-4 hidden flex-wrap items-center justify-center gap-x-8 gap-y-2 text-[13px] text-zinc-300 sm:flex">
