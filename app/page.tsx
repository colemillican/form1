          ...
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-slate-700">
                We believe the most important work is human work—care, judgment,
                service, and presence. IronGate exists to remove the digital
                burden that pulls teams away from that calling. We build private
                AI infrastructure that strengthens operations, protects sensitive
                records, and gives your people time back to do what they do best.
              </p>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-950 to-slate-800 p-8 shadow-[0_26px_80px_rgba(15,23,42,0.22)]">
              <div className="absolute inset-0 opacity-25 [background-image:radial-gradient(circle_at_20%_20%,rgba(251,191,36,0.55),transparent_55%),radial-gradient(circle_at_80%_30%,rgba(56,189,248,0.45),transparent_55%)]" />
              <div className="relative">
                ...
                <p className="mt-3 text-sm leading-relaxed text-white/75">
                  Your organization should not have to trade confidentiality for
                  capability. We deploy AI where your data lives—inside your
                  environment—so your systems become faster, stronger, and more
                  secure over time.
                </p>

                <div className="mt-6 grid grid-cols-3 gap-3 text-[0.7rem] text-white/80">
                  <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2">
                    <p className="font-semibold text-white/90">Private</p>
                    <p className="mt-1">Data stays in your control.</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2">
                    <p className="font-semibold text-white/90">Powerful</p>
                    <p className="mt-1">Real infrastructure, not hype.</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2">
                    <p className="font-semibold text-white/90">Human</p>
                    <p className="mt-1">Time back for real work.</p>
                  </div>
                </div>
              </div>
            </div>
