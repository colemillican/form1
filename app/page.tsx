          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <input
                ...
                className="h-10 w-full max-w-[520px] sm:w-80 rounded-full border border-white/10 bg-white/5 px-5 text-[14px] placeholder:text-zinc-500 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/70 transition"
              />
            ...
            <p className="mt-6 text-[13px] uppercase tracking-[0.18em] text-zinc-400">
