      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-screen-2xl px-6 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            {/* CENTRAL START CARD – simplified & better aligned */}
            <div className="mt-8 mx-auto max-w-xl rounded-3xl border border-emerald-100/80 bg-white/97 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.35)] sm:p-5">
              <p className="mb-3 text-center text-[13px] font-medium text-zinc-700">
      ...
      <section id="process" className="border-t border-white/10 bg-black">
        <div className="mx-auto w-full max-w-screen-2xl px-6 py-14 sm:px-8">
          ...
          <p className="mt-2 max-w-xl text-sm text-zinc-300 sm:text-base">
            ...
            outdated site (or no site) to something you&apos;s proud to show
            off.
          </p>
