...
export default function Page() {
  return (
    <SiteChrome>
      {/* HERO – ultra simple, no-brainer offer */}
      <section
      ...
      >
        ...
        {/* Soft, balanced glows */}
        <div className="pointer-events-none absolute -top-24 -left-40 h-[40vh] w-[40vh] rounded-full bg-emerald-500/14 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-40 -right-40 h-[40vh] w-[40vh] rounded-full bg-sky-500/12 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-screen-2xl px-6 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            {/* CENTRAL START CARD – the “Base44” style interaction */}
            <div className="mt-8 mx-auto max-w-xl rounded-3xl border border-black/5 bg-white/95 p-4 text-left shadow-[0_18px_60px_rgba(0,0,0,0.45)] sm:p-5">
              <p className="mb-2 text-[13px] font-medium text-zinc-600">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
                <input
                  ...
                  className="h-11 flex-1 rounded-full border border-zinc-200 bg-white px-4 text-[14px] text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/70"
                />
                <button
                  type="button"
                  className="h-11 rounded-full bg-emerald-500 px-5 text-[14px] font-semibold text-black shadow-sm hover:bg-emerald-400 transition sm:px-6"
                >
                  Get my free website plan
                </button>
              </div>
              <p className="mt-2 text-[11px] text-zinc-500">
                No payment, no obligation. We’ll review what you share and send
                back a custom website outline.
              </p>
            </div>

            {/* Credibility + trust row */}
            <p className="mt-7 text-[13px] uppercase tracking-[0.18em] text-zinc-400">
